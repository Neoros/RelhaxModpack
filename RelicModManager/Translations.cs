...
namespace RelhaxModpack
{
    ...
    public static class Translations
    {
        ...
        public static void loadHashes()
        {
			...
			polish.Add("noUninstallLogMessage", "Plig logów zawierajćacy listę plików (installedRelhaxFiles.log) nie istnieje. Czy chciałbyś usunąć wszystkie mody?");
		    ...
		    polish.Add("duplicateMods", "BŁĄD KRYTYCZNY: Wykryto modyfikacje o zduplikowanych nazwach");
			...
			polish.Add("configSaveSucess", "Konfiguracja zapisana");
			...
			polish.Add("selectConfigFile", "Wybierz plik do załadowania");
			...
			polish.Add("configLoadFailed", "Plik konfiguracji nie może być wczytany, padowanie trybu podstawowego");
            ...
            polish.Add("modNotFound_2", "\" nie została znaleziona. Mogła zostać zmieniona nazwa lub usunięta.");
			...
			polish.Add("patchingSystemDeneidAccessMessage", "Nie uzyskano dostępu do folderu z patchem. Spróbuj ponownie jako administrator. Jeśli widzisz to ponownie, to zmień ustawienia dostępu");
					   
            //Componet: 
            //
            english.Add("patchingSystemDeneidAccessHeader", "Access Deneid");
            german.Add("patchingSystemDeneidAccessHeader", "Zugriff abgelehnt");
		    polish.Add("patchingSystemDeneidAccessHeader", "Odmówiono dostępu");
			...
			polish.Add("databaseNotFound", "Nie znaleziono bazy danych pod tym URL");
					   
            //Componet:
            //
            english.Add("WoTRunningHeader", "WoT is Running");
            german.Add("WoTRunningHeader", "WoT wird gerade ausgeführt.");
			polish.Add("WoTRunningHeader", "WoT działa");
			...
			polish.Add("WoTRunningMessage", "Proszę zamknij World of Tanks, aby kontynuować");
		    ...
		    polish.Add("zipReadingErrorHeader", "Niekompletność pobranych plików");

            //Componet:
            //
            english.Add("zipReadingErrorMessage1", "The zip file");
            german.Add("zipReadingErrorMessage1", "Die Zip-Datei");
			polish.Add("zipReadingErrorMessage1", "Plik skompresowany w formacie ZIP");		   
			...
			polish.Add("zipReadingErrorMessage2", "Nie można odczytać. Prawdopodobnie pobrano niekompletne pliki. Zostanie to pominięte. Spróbuj ponownie później.");		   
        }
    }
}
